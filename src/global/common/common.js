...
const urls = {
  'dev': {
    Api: 'https://www.easy-mock.com/mock/5add7e95fe29a6045d0a7baa/study/',
    mUrl: 'http://loaclhost:6888/',
    pUrl:'http://localhost:6888/'
  },
  'test': {
    Api: 'http//mtest.chenchaoc.top/',
    mUrl: 'http://m.test.elineprint.com/',
    pUrl: 'http://test.elineprint.com/'
  },
  'beta': {
    Api: 'http//mbeta.chenchaoc.top/',
    mUrl: 'http://m.test.elineprint.com/',
    pUrl: 'http://test.elineprint.com/'
  },
  'prod1': {
    Api: 'https://www.easy-mock.com/mock/5add7e95fe29a6045d0a7baa/study/',
    mUrl: 'http://m.elineprint.com/',
    pUrl: 'http://www.elineprint.com/'
  }
}
// 注入window.pageConfig
